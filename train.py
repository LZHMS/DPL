...
def extend_cfg(cfg, args):
    ...
    cfg.TRAINER.POMA = CN()
    cfg.TRAINER.POMA.N_CTX = 16  # number of context vectors
    cfg.TRAINER.POMA.CSC = False  # class-specific context
    cfg.TRAINER.POMA.CTX_INIT = ""  # initialization words
    cfg.TRAINER.POMA.PREC = "fp16"  # fp16, fp32, amp
    cfg.TRAINER.POMA.CLASS_TOKEN_POSITION = "end"  # 'middle' or 'end' or 'front'
