...
CUDA_VISIBLE_DEVICES=0 bash poma_train.sh ssdtd rn50_ep50 end 16 16 4 False True rn50_random_init 0
CUDA_VISIBLE_DEVICES=0 bash poma_train.sh ssdtd rn50_ep50 end 16 16 4 False True rn50_random_init 2
CUDA_VISIBLE_DEVICES=0 bash poma_train.sh ssdtd rn50_ep50 end 16 16 4 False True rn50_random_init 4
CUDA_VISIBLE_DEVICES=0 bash poma_train.sh ssdtd rn50_ep50 end 16 16 4 False True rn50_random_init 8
